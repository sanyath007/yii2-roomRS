...
/**
 * User model from table personal on (192.168.20.4).db_ksh
 *
...
//    }
    ...
    {
        return static::findOne(['person_id' => $id]);
...
//        return $timestamp + $expire >= time();
    ...
    {
        return ($password === $this->person_password) ? true : false;
//        return Yii::$app->security->validatePassword($password, $this->person_password);
    }
...
//        $this->password_hash = Yii::$app->security->generatePasswordHash($password);
    ...
    {
        return $this->hasMany(Position::className(), ['position_id' => 'position_id']);
    }
}
